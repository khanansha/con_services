...
class AirportLounge(models.Model):
    ...
    Country = models.CharField(max_length=10, choices=Select_Country)
    ...
    #Package_Details = models.TextField(max_length=100, default="")
    Brief_Over = models.TextField(max_length=500)
    Status = models.IntegerField(default=0, choices=STATUS)
    AddedOn = models.DateField()


class AirportLounge_images(models.Model):
    airportlounge = models.ForeignKey(
        AirportLounge, on_delete=models.CASCADE, related_name='airportlounge')
    # Package_Details = models.TextField(max_length=100,default="")
    images = models.ImageField(upload_to='airportlounge/images', default="")

class PackageDetails (models.Model):
    airportlounge = models.ForeignKey(
        AirportLounge, on_delete=models.CASCADE, related_name='airport')
    Package_Details = models.TextField(max_length=100, default="")    
